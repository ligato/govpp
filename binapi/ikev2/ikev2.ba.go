...
func (m *Ikev2ProfileDetails) Size() int {
	if m == nil {
		return 0
	}
	var size int
	...
	size += 1                            // m.Profile.LocTs.TsType
	size += 1                            // m.Profile.LocTs.ProtocolID
	size += 2                            // m.Profile.LocTs.SelectorLen
	...
	size += 1                            // m.Profile.RemTs.TsType
	size += 1                            // m.Profile.RemTs.ProtocolID
	size += 2                            // m.Profile.RemTs.SelectorLen
...
func (m *Ikev2ProfileDetails) Marshal(b []byte) ([]byte, error) {
	...
	buf.EncodeUint8(uint8(m.Profile.LocID.Type))
	buf.EncodeUint8(uint8(m.Profile.LocID.DataLen))
	buf.EncodeString(m.Profile.LocID.Data, 64)
	buf.EncodeUint8(uint8(m.Profile.RemID.Type))
	buf.EncodeUint8(uint8(m.Profile.RemID.DataLen))
	buf.EncodeString(m.Profile.RemID.Data, 64)
	buf.EncodeUint8(uint8(m.Profile.LocTs.TsType))
	buf.EncodeUint8(uint8(m.Profile.LocTs.ProtocolID))
	buf.EncodeUint16(uint16(m.Profile.LocTs.SelectorLen))
	buf.EncodeUint16(uint16(m.Profile.LocTs.StartPort))
	buf.EncodeUint16(uint16(m.Profile.LocTs.EndPort))
	buf.EncodeBytes(m.Profile.LocTs.StartAddr[:], 4)
	buf.EncodeBytes(m.Profile.LocTs.EndAddr[:], 4)
	buf.EncodeUint8(uint8(m.Profile.RemTs.TsType))
	buf.EncodeUint8(uint8(m.Profile.RemTs.ProtocolID))
	buf.EncodeUint16(uint16(m.Profile.RemTs.SelectorLen))
	buf.EncodeUint16(uint16(m.Profile.RemTs.StartPort))
	buf.EncodeUint16(uint16(m.Profile.RemTs.EndPort))
	...
	buf.EncodeUint8(uint8(m.Profile.IkeTs.CryptoAlg))
	buf.EncodeUint8(uint8(m.Profile.IkeTs.IntegAlg))
	buf.EncodeUint8(uint8(m.Profile.IkeTs.DhType))
	buf.EncodeUint32(uint32(m.Profile.IkeTs.CryptoKeySize))
	buf.EncodeUint8(uint8(m.Profile.EspTs.CryptoAlg))
	buf.EncodeUint8(uint8(m.Profile.EspTs.IntegAlg))
	buf.EncodeUint8(uint8(m.Profile.EspTs.DhType))
	buf.EncodeUint32(uint32(m.Profile.EspTs.CryptoKeySize))
	buf.EncodeUint64(uint64(m.Profile.Lifetime))
	buf.EncodeUint64(uint64(m.Profile.LifetimeMaxdata))
	buf.EncodeUint32(uint32(m.Profile.LifetimeJitter))
	buf.EncodeUint32(uint32(m.Profile.Handover))
	buf.EncodeUint16(uint16(m.Profile.IpsecOverUDPPort))
	buf.EncodeUint32(uint32(m.Profile.TunItf))
	buf.EncodeUint8(uint8(m.Profile.UDPEncap))
	buf.EncodeUint8(uint8(m.Profile.Auth.Method))
	buf.EncodeUint8(uint8(m.Profile.Auth.Hex))
...
func (m *Ikev2ProfileDetails) Unmarshal(b []byte) error {
	...
	m.Profile.LocTs.TsType = buf.DecodeUint8()
	m.Profile.LocTs.ProtocolID = buf.DecodeUint8()
	m.Profile.LocTs.SelectorLen = buf.DecodeUint16()
	...
	m.Profile.RemTs.TsType = buf.DecodeUint8()
	m.Profile.RemTs.ProtocolID = buf.DecodeUint8()
	m.Profile.RemTs.SelectorLen = buf.DecodeUint16()
	...
	m.Profile.Responder.SwIfIndex = buf.DecodeUint32()
	...
	m.Profile.IkeTs.DhType = buf.DecodeUint8()
	...
	m.Profile.EspTs.DhType = buf.DecodeUint8()
...
func (m *Ikev2ProfileDump) Size() int {
	if m == nil {
		return 0
	}
	var size int
...
func file_ikev2_binapi_init() {
	...
	api.RegisterMessage((*Ikev2ProfileDetails)(nil), "ikev2_profile_details_223b87fc")
