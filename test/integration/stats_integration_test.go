...
func BenchmarkStatClientStatsUpdate1(b *testing.B)   { benchStatClientStatsLoad(b, 1) }
func BenchmarkStatClientStatsUpdate10(b *testing.B)  { benchStatClientStatsLoad(b, 10) }
func BenchmarkStatClientStatsUpdate100(b *testing.B) { benchStatClientStatsLoad(b, 100) }

func benchStatClientStatsLoad(b *testing.B, repeatN int) {
	client := statsclient.NewStatsClient(*statsSocket)
	c, err := core.ConnectStats(client)
	if err != nil {
		b.Fatal("Connecting failed:", err)
